...
- **bamdra-openclaw-memory** — Continuity-first memory runtime for OpenClaw with durable SQLite recall, user-aware identity binding, and optional local Markdown knowledge retrieval.
